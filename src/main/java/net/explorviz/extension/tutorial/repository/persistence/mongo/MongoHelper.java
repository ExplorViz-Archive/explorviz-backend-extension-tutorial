...
//  public static final String FIELD_REQUESTS = "totalRequests";
	...
	private static final String DEFAULT_PORT = "27090";
	private static final String DEFAULT_DB = "explorviz";
	private static final String TUTORIAL_COLLECTION = "tutorial";
	private static final String SEQUENCE_COLLECTION = "sequence";
	private static final String STEP_COLLECTION = "step";
	...
	/*
	 * From mongo documentation: "It is important to limit the number of MongoClient
	 * instances in your application, hence why we suggest a singleton - the
	 * MongoClient is effectively the connection pool, so for every new MongoClient,
	 * you are opening a new pool."
	 */
	/**
	...
	/**
	 * Returns a {@link MongoClient} which is connected to the database given in the
	 * configuration file. This method is private in order to prevent unintentional
	...
	/**
	 * Returns a connection to the tutorial collection.
	 */
	public MongoCollection<Document> getTutorialCollection() {
		return this.getDatabase().getCollection(TUTORIAL_COLLECTION);
	}

	public MongoCollection<Document> getSequenceCollection() {
		return this.getDatabase().getCollection(SEQUENCE_COLLECTION);
	}

	public MongoCollection<Document> getStepCollection() {
		return this.getDatabase().getCollection(STEP_COLLECTION);
	}
	...
	/**
	 * Closes all resources associated with this instance, in particular any open
	 * network connections. Once called, this instance and any databases obtained
